...
// 🟢71🟢  Find Even & Odd Numbers Separately
// Write a function that takes an array of numbers and returns two arrays:

// One for even numbers
// One for odd numbers

// let arr=[19,26,34,75,25,63,57,85]

// let result=arr.reduce((acc,curr)=>{ if(curr%2===0){acc.even.push(curr)}else{acc.odd.push(curr)} return acc},{even:[],odd:[]})
// console.log(result);


// 🟢🟢Count Positive, Negative & Zero

// let arr= [1, -2, 3, 0, -5, 0, 6]

// let result=arr.reduce((acc,curr)=>{(curr>0)?acc.positive++ :(curr<0)?acc.negative++:(curr==0)?acc.zero++:curr;return acc },{positive:0 , negative:0 , zero: 0})

// console.log(result)

//🟢🟢Remove Duplicates Without Using Set
// Write a function that removes duplicates from an array without using Set.
...
// Write a function that takes an array of numbers and counts:

// How many numbers are greater than 10
// How many numbers are less than or equal to 10


// let arr=[5, 12, 18, 9, 7]

// let result=arr.reduce((acc,curr)=>{(curr>10)?acc.greaterThan10++:(curr<=10)?acc.lessOrEqual10++:acc;return acc},{greaterThan10: 0, lessOrEqual10: 0})

// console.log(result);


//🟢🟢 Move All Zeros to End
// Write a function that moves all 0s in an array to the end without changing the order of other elements.
...
//🟢🟢Write a function that filters an array of strings and keeps only the words that contain the letter 'a'

let arr=["apple", "banana", "cherry", "dog"]

let result=arr.filter(word=>word.split("").includes("a"))
