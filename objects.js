...
// ❤️❤️❤️❤️❤️❤️❤️❤️❤️❤️❤️❤️basic again question
...
// person.name="manngesh"
// person.age=234

// console.log(person);

// //4
// let girl=Object.create(null)
// girl.name="gaurii"
// girl.age=20
// console.log(girl);
// delete girl.age
// console.log(girl);
// console.log("age" in girl)
...
// let person1=new P1("Rajesh",33)
// console.log(person1);

// class p2{
//         constructor(mobile,insta){
//                 this.mobile=mobile;
//                 this.insta=insta;
...
// let personnn=new p2(2342345,"its_aditya")
// console.log(personnn);

// 🟢🟢Create an object calculator with methods add(a, b) and subtract(a, b).
...
// 🟢🟢Loop through an object and print all key-value pairs.
...
// let result=Object.entries(obj).map(([key,value])=>`key: ${key},value :${value}`);

// console.log(JSON.stringify(result));

// 🟢🟢Create an object user with a method greet() that logs "Hello, my name is X" using this.
...
//🟢🟢Convert an object to a JSON string and then parse it back to an object.
...
// let result2=JSON.stringify(obj.name)
...
// 🟢🟢Merge two objects {a: 1, b: 2} and {c: 3, d: 4} into a single object.
...
// //🟢🟢Create an object using a constructor function for Person with name and age.
...
//         let p1=new Person("adi",23)
//         console.log(p1);

// 🟢🟢Create an object using the class syntax with properties title and price
...
// let obj1=new Object1("laptop",800000)

// console.log(obj1);

//🟢🟢Create an array of objects and find an object where age > 25.
...
// let result=arr.filter(person=>person.age>25)
// console.log(result);

//🟢🟢Create a function createPerson(name, age) that returns an object with a method getDetails() that returns "Name: X, Age: Y"


//        function getDetails(namea, age){
//                 console.log(`Name: X${namea}, Age: ${age}`);
                

//         }


// let result=getDetails("adi",22)


// 🟢🟢Create an object cache that stores function results and returns cached results for the same input.

//🟢🟢 Implement a Car class with properties brand, model, year and a method getAge() that calculates the car’s age.
...
// let result=new Car("tata","nexno",2017)
// console.log(result.getAge());


//🟢🟢Write a function that takes an object and returns the key with the highest value.

// let obj={ Alice: 78, Bob: 92, Charlie: 85 }

// let result=Object.entries(obj).reduce((acc,curr)=>(acc[1]>curr[1])?acc :curr)
// console.log(result[0]);


//🟢🟢Write a function that counts how many properties in an object are strings, numbers, or booleans.


// let obj= { name: "John", age: 25, married: false, city: "NY" }

// let result=Object.entries(obj).reduce((acc,curr)=>{(typeof curr[1]==="string")?acc.string++:(typeof curr[1]==="number")?acc.number++:(typeof curr[1]==="boolean")?acc.boolean++:curr;return acc},{string:0,number:0,boolean:0})


// console.log(result);


//🟢🟢Given an array of objects, return all users older than 30
...
//       let result=obj.filter(user=>user.age>30)
...
//🟢🟢Write a function that takes an object and finds the most repeated value.

let  votes = { John: "A", Alice: "B", Bob: "A", Mike: "A", Carol: "B" }
